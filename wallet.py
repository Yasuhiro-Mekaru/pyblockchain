...
class Wallet(object):
    ...
    def generate_blockchain_address(self):
        ...
        network_bitcoin_public_key_byte = codecs.decode(
...
################# BlockChain Node
    ...
    print('A', block_chain.culculate_total_amount(wallet_A.blockchain_address))
    print('B', block_chain.culculate_total_amount(wallet_B.blockchain_address))
